...
public class WithdrawView extends JPanel {
    ...
    public WithdrawView(Card card, Account account, DashboardView parentDashboard) {
        this.card = card;
    ...
    private void initComponents() {
        ...
        // Header - NO EMOJI
        JLabel lblTitle = new JLabel("Tarik Uang");
        lblTitle.setFont(new Font(UIConstants.FONT_FAMILY, Font.BOLD, 28));
        lblTitle.setForeground(UIConstants.TEXT_PRIMARY);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Tarik tunai dari rekening Anda");
        ...
        JLabel lblInfo = new JLabel("Informasi Penting:");
        lblInfo.setFont(UIConstants.FONT_BODY_BOLD);
        lblInfo.setForeground(UIConstants.WARNING);
        lblInfo.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel lblInfo1 = new JLabel("• Jumlah harus kelipatan Rp 50.000");
        ...
        JLabel lblInfo2 = new JLabel("• Pastikan saldo mencukupi");
        ...
        // Amount
        JLabel lblAmount = new JLabel("Jumlah Penarikan");
        ...
        JLabel lblHint1 = new JLabel("Contoh: 50000, 100000, 150000");
        ...
        // PIN
        JLabel lblPin = new JLabel("PIN Kartu ATM");
        ...
        JLabel lblHint2 = new JLabel("Masukkan 6 digit PIN Anda");
        ...
        btnWithdraw = UIComponents.createDangerButton("Tarik Uang");
    ...
    private void handleWithdraw() {
        ...
        if (!card.getPin().equals(pin)) {
            JOptionPane.showMessageDialog(parentDashboard, "PIN salah!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            SwingWorker<String, Void> worker = new SwingWorker<String, Void>() {
                ...
                protected String doInBackground() {
                    return transactionController.withdraw(account.getId(), amount, pin);
                }
                ...
                protected void done() {
                    try {
                        ...
                        btnWithdraw.setText("Tarik Uang");
